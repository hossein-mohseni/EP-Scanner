...
1. **اجرای برنامه**:
   - فایل فشرده نرم افزار را از [این لینک](https://github.com/hossein-mohseni/EP-Scanner/releases/download/v0.2.0/EPscanner.zip) دانلود و استخراج کنید سپس `EPscanner.exe` را اجرا کنید.
